...
<div class="main-sidebar">
  ...
  <section class="section">
    <div class="section-body">
        ...
        <div class="card mt-0">
            <form action="/dtrumussave" method="POST" class="">
            @csrf
              <div class="card-header">
                <h4 class="section-title" >Form Tambah Data Rumus </h4>
              </div>
              <div class="card-body">
                <div class="form-group row">
                    ...
                    @foreach($prodi as $pd)
                        <option value="{{ $pd->id_prodi }}"> {{ $pd->nama_prodi }}</option>
                    @endforeach
                    </select>
                    </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-sm-4"> <input type="text" class="form-control" name="pengali_sks" placeholder="1" required>
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-sm-3 col-form-label">Harga Kehadiran</label>
                  <div class="col-sm-4">
                    <input type="text" class="form-control" name="harga_kehadiran" placeholder="33500" required>
                  </div>
                </div>
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Pengali Kehadiran</label>
                    <div class="col-sm-4">
                      <input type="text" class="form-control" name="pengali_jum_hadir"  placeholder="15000" required>
                    </div>
                </div>
                <div class="form-group row">
