...
<section class="section">
    <div class="section-body">
        ...
        <div class="card mt-0">
            <form action="/dtmkaddsave" method="POST" class="">
                @csrf
              <div class="card-header">
                <h4 class="section-title" >Form Tambah Data Matakuliah </h4>
              </div>
              <div class="card-body">
                <div class="form-group row">
                  <label class="col-sm-3 col-form-label">Kode Matakuliah</label>
                  <div class="col-sm-4"> <input type="text" class="form-control" name="kode_mk" placeholder="SI2022" required>
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-sm-3 col-form-label">Nama Matakuliah</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="nama_mk" placeholder="Sistem Informasi" required>
                  </div>
                </div>
                <div class="form-group row">
