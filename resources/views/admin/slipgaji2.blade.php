  ...
  <section class="section">
    <div class="section-body">
        <ul class="breadcrumb mb-2">
            <h1 class="section-title"><a href="/slipgaji" class="text-dark">Slip Gaji</a> > </h1>
            @foreach($prodi as $pd)
              ...
              <table class="table table-sm">
                ...
                @foreach($gaji as $no=>$gj)
                  <tr>
                    ...
                    <td>{{ $gj->pajak  }}</td>
                    <td>{{ $gj->diterima  }}</td>
                    <td><a href="/arsip/pdfslip/{{ $gj->id_gaji }}" type="button" class="btn btn-info btn-sm">Lihat</a>
                    </td>
                  </tr>
                  @endforeach
                </tbody>
